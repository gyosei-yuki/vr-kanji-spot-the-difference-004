    ...
    init: function () {
      ...
      el.addEventListener('raycaster-intersection', (evt) => {
        ...
        if (this.target_el.classList.contains('first-end')) {
          ...
          quiz1.setAttribute('material', { src: '#q-gyu1', normalMap: '#q-gyu1-NRM' });
          ...
          quiz2.setAttribute('material', { src: '#q-gyu2', normalMap: '#q-gyu2-NRM' });
          ...
          quiz3.setAttribute('material', { src: '#q-gyu3', normalMap: '#q-gyu3-NRM' });
          ...
          quiz4.setAttribute('material', { src: '#q-sha1', normalMap: '#q-sha1-NRM' });
          ...
          quiz5.setAttribute('material', { src: '#q-sha2', normalMap: '#q-sha2-NRM' });
          ...
          quiz6.setAttribute('material', { src: '#q-sha3', normalMap: '#q-sha3-NRM' });
          ...
          quiz7.setAttribute('material', { src: '#q-ken1', normalMap: '#q-ken1-NRM' });
          ...
          quiz8.setAttribute('material', { src: '#q-ken2', normalMap: '#q-ken2-NRM' });
          ...
          quiz9.setAttribute('material', { src: '#q-ken3', normalMap: '#q-ken3-NRM' });
          ...
          quiz10.setAttribute('material', { src: '#q-ki1', normalMap: '#q-ki1-NRM' });
          ...
          quiz11.setAttribute('material', { src: '#q-ki2', normalMap: '#q-ki2-NRM' });
          ...
          quiz12.setAttribute('material', { src: '#q-ki3', normalMap: '#q-ki3-NRM' });
